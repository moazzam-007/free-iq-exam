(() => {
  ...
  const LIKERT_OPTIONS = [
    { value: 0, label: 'Not at all', detail: '0 days' },
    { value: 1, label: 'Several days', detail: '1–6 days' },
    { value: 2, label: 'More than half the days', detail: '7–11 days' },
    { value: 3, label: 'Nearly every day', detail: '12–14 days' }
  ];

  const FUNCTIONAL_OPTIONS = [
    { value: 0, label: 'Not difficult at all', detail: 'No interference' },
    { value: 1, label: 'Somewhat difficult', detail: 'Mild interference' },
    { value: 2, label: 'Very difficult', detail: 'Marked interference' },
    { value: 3, label: 'Extremely difficult', detail: 'Severe interference' }
  ];
  ...
  const QUESTIONS = [
    {
      id: 1,
      axis: 'cognitive',
      context: 'Autonomic apprehension · affective tension',
      text: 'Feeling nervous, anxious, or on edge'
    },
    {
      id: 2,
      axis: 'cognitive',
      context: 'Metacognitive control · worry uncontrollability',
      text: 'Not being able to stop or control worrying'
    },
    {
      id: 3,
      axis: 'cognitive',
      context: 'Generalized apprehension · diffuse catastrophic ideation',
      text: 'Worrying too much about different things'
    },
    {
      id: 4,
      axis: 'somatic',
      context: 'Autonomic arousal · muscular & neuromuscular tension',
      text: 'Trouble relaxing'
    },
    {
      id: 5,
      axis: 'somatic',
      context: 'Psychomotor agitation · sympathetic hyper-activation',
      text: 'Being so restless that it is hard to sit still'
    },
    {
      id: 6,
      axis: 'somatic',
      context: 'Affective reactivity · nervous system threshold lowering',
      text: 'Becoming easily annoyed or irritable'
    },
    {
      id: 7,
      axis: 'cognitive',
      context: 'Catastrophic anticipation · dread & impending doom',
  ...
  const FUNCTIONAL_ITEM = {
    id: 8,
    axis: 'functional',
    context: 'Supplementary item · functional impairment',
  ...
  async function shareResult() {
    ...
    try {
      if (navigator.share) {
        await navigator.share({ title: 'FreeIQExam GAD-7 Screener', text, url: window.location.href });
        return;
      }
