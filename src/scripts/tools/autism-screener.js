(() => {
   ...
   *   direction 'agree'    → Definitely/Slightly Agree scores 1
   *   direction 'disagree' → Slightly/Definitely Disagree scores 1
  ...
  const QUESTIONS = [
    { id: 1, subscale: 'sensory', direction: 'agree', context: 'Sensory · Attention to Detail', text: 'I often notice small sounds when others do not.' },
    { id: 2, subscale: 'sensory', direction: 'disagree', context: 'Global vs Local Processing', text: 'I usually concentrate more on the whole picture, rather than the small details.' },
    { id: 3, subscale: 'attention', direction: 'disagree', context: 'Attention Switching', text: 'I find it easy to do more than one thing at once.' },
    { id: 4, subscale: 'attention', direction: 'disagree', context: 'Attention Switching', text: 'If there is an interruption, I can switch back to what I was doing very quickly.' },
    { id: 5, subscale: 'social', direction: 'disagree', context: 'Social Communication', text: "I find it easy to 'read between the lines' when someone is talking to me." },
    { id: 6, subscale: 'social', direction: 'disagree', context: 'Social Relating', text: 'I know how to tell if someone listening to me is getting bored.' },
    { id: 7, subscale: 'social', direction: 'agree', context: 'Theory of Mind · Social Context', text: "When I'm reading a story I find it difficult to work out the characters' intentions." },
    { id: 8, subscale: 'systematizing', direction: 'agree', context: 'Systematizing · Circumscribed Interests', text: 'I like to collect information about categories of things.' },
    { id: 9, subscale: 'social', direction: 'disagree', context: 'Facial Affect · Empathy', text: 'I find it easy to work out what someone is thinking or feeling just by looking at their face.' },
    { id: 10, subscale: 'social', direction: 'agree', context: 'Social Relating', text: 'I find it difficult to make new friends.' }
  ];

  const SUBSCALES = {
    social: { label: 'Social Communication', short: 'Social', max: 5, color: '#10b981', blurb: 'Theory of mind, cue interpretation, reciprocity' },
    sensory: { label: 'Sensory & Detail Focus', short: 'Sensory', max: 2, color: '#06b6d4', blurb: 'Sensory awareness, local vs global processing' },
    attention: { label: 'Attention Switching', short: 'Switching', max: 2, color: '#8b5cf6', blurb: 'Task-switch friction, routine preservation' },
    systematizing: { label: 'Systematizing Interests', short: 'System.', max: 1, color: '#f59e0b', blurb: 'Pattern focus, categorization, deep interests' }
  };
  ...
  function renderQuestion() {
    ...
    $('question-part').textContent = 'AQ-10 · Adult autism screener';
  ...
  function resetAssessment() {
    ...
    announce('Assessment reset. Ready to begin again.');
  }
