...
(function () {
  ...
  const SoundApp = {
    ...
    bindDOM() {
      ...
      document.querySelectorAll('.noise-color-btn').forEach((btn) => {
        btn.addEventListener('click', () => {
          ...
          document.querySelectorAll('.noise-color-btn').forEach((b) => b.classList.remove('active', 'border-amber-500', 'bg-amber-500/10', 'text-amber-400'));
          btn.classList.add('active', 'border-amber-500', 'bg-amber-500/10', 'text-amber-400');
      ...
      document.querySelectorAll('.binaural-wave-btn').forEach((btn) => {
        btn.addEventListener('click', () => {
          document.querySelectorAll('.binaural-wave-btn').forEach((b) => b.classList.remove('active', 'bg-indigo-500/20', 'text-indigo-400', 'border-indigo-500/40'));
          btn.classList.add('active', 'bg-indigo-500/20', 'text-indigo-400', 'border-indigo-500/40');
      ...
      document.querySelectorAll('.timer-btn').forEach((btn) => {
        btn.addEventListener('click', () => {
          document.querySelectorAll('.timer-btn').forEach((b) => b.classList.remove('active', 'bg-amber-500/10', 'text-amber-400', 'border-amber-500/40'));
          btn.classList.add('active', 'bg-amber-500/10', 'text-amber-400', 'border-amber-500/40');
    ...
    updatePlayState(playing) {
      ...
      if (masterText) {
        masterText.textContent = playing ? 'Pause Soundscape' : 'Play Soundscape';
      }
      if (floatIcon) {
    ...
    syncUI() {
      ...
      document.querySelectorAll('.noise-color-btn').forEach((b) => {
        if (b.dataset.color === this.engine.activeColor) {
          b.classList.add('active', 'border-amber-500', 'bg-amber-500/10', 'text-amber-400');
        } else {
          b.classList.remove('active', 'border-amber-500', 'bg-amber-500/10', 'text-amber-400');
        }
      });
      ...
      document.querySelectorAll('.binaural-wave-btn').forEach((b) => {
        if (b.dataset.wave === this.engine.binauralType) {
          b.classList.add('active', 'bg-indigo-500/20', 'text-indigo-400', 'border-indigo-500/40');
        } else {
          b.classList.remove('active', 'bg-indigo-500/20', 'text-indigo-400', 'border-indigo-500/40');
        }
      });
    }
  };
