  ...
  class CalorieEngine {
    ...
    getNeuroMetabolicMetrics() {
      ...
      return {
        ...
        desc: 'The human brain comprises ~2% of body mass but commands 20% of resting metabolic energy (continuous glucose perfusion).'
      };
    }
    ...
    bindDOM() {
      ...
      document.querySelectorAll('.cal-unit-btn').forEach((btn) => {
        btn.addEventListener('click', () => {
          document.querySelectorAll('.cal-unit-btn').forEach((b) => b.classList.remove('active', 'bg-emerald-500/10', 'text-emerald-500', 'border-emerald-500/40'));
      ...
      document.querySelectorAll('.cal-gender-btn').forEach((btn) => {
        btn.addEventListener('click', () => {
          document.querySelectorAll('.cal-gender-btn').forEach((b) => b.classList.remove('active', 'bg-emerald-500/10', 'text-emerald-500', 'border-emerald-500/40'));
          btn.classList.add('active', 'bg-emerald-500/10', 'text-emerald-500', 'border-emerald-500/40');
      ...
      document.querySelectorAll('.cal-goal-btn').forEach((btn) => {
        btn.addEventListener('click', () => {
          document.querySelectorAll('.cal-goal-btn').forEach((b) => b.classList.remove('active', 'bg-emerald-500/10', 'text-emerald-500', 'border-emerald-500/40'));
          btn.classList.add('active', 'bg-emerald-500/10', 'text-emerald-500', 'border-emerald-500/40');
      ...
      if (calcNavyBtn) {
        calcNavyBtn.addEventListener('click', () => {
          ...
          if (bf) {
            ...
            if (bfBadge) {
              bfBadge.textContent = `${bf}% Body Fat Applied`;
