...
(function () {
  ...
  var PRESETS = {
    work: {
      title: 'Рабочие дедлайны и перегрузка',
      icon: '💼',
      items: [
        { text: 'Моя подготовка и фокус на текущей задаче', zone: 'control' },
        { text: 'Приоритеты на ближайшие 90 минут', zone: 'control' },
        { text: 'Уточняющие вопросы руководителю', zone: 'influence' },
        { text: 'Сдадут ли коллеги свои части вовремя', zone: 'influence' },
        { text: 'Настроение руководства этим утром', zone: 'concern' },
  ...
  function buildPlanText() {
    ...
    lines.push(resolveShareUrl('https://freeiqexam.com/ru/circle-of-control'));
    return lines.join('\n');
  }
