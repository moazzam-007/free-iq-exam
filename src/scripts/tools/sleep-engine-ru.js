...
(function () {
  ...
  const STAGE_META = {
    awake: { label: 'Бодрствование',     depth: 0, y: 18,  color: '#fbbf24' },
    rem:   { label: 'Быстрый сон (REM)',       depth: 1, y: 54,  color: '#f472b6' },
    n1:    { label: 'N1 (Дремота)',        depth: 2, y: 90,  color: '#a78bfa' },
    n2:    { label: 'N2 (Легкий сон)',        depth: 3, y: 126, color: '#818cf8' },
    n3:    { label: 'N3 (Глубокий сон)',  depth: 4, y: 162, color: '#4338ca' }
  };

  const CYCLE_TIERS = {
    6: {
      key: 'optimal',
      label: 'Оптимальное восстановление (6 циклов)',
      short: 'Optimal',
      tone: 'optimal',
    ...
    5: {
      key: 'baseline',
      label: 'Рекомендованная норма (5 циклов)',
      short: 'Baseline',
      tone: 'baseline',
    ...
    4: {
      key: 'minimum',
      label: 'Функциональный минимум (4 цикла)',
      short: 'Minimum',
      tone: 'minimum',
    ...
    3: {
      key: 'deficit',
      label: 'Риск дефицита сна (≤3 циклов)',
      short: 'Deficit',
      tone: 'deficit',
